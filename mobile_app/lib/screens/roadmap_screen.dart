  ...
  Future<void> _fetchRoadmap(String code, String title) async {
    ...
    try {
      final response = await http.post(
        Uri.parse('${AppConfig.baseUrl}/roadmap'),
  ...
  Widget build(BuildContext context) {
    if (selectedJobs.isEmpty) {
      return Scaffold(
        ...
        appBar: AppBar(title: const Text("Career Strategy")),
        body: const Center(
          child: Text("No strategy found. Please go back and select jobs."),
        ),
      );
    }
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
                ...
                .map(
                  (j) => Tab(
                    child: Padding(
                      ...
                      child: Text(
                        j['title'].toString().split(' ').take(2).join(' '),
                      ),
                    ),
                  ),
                )
        ...
        body: AnimatedGradientBackground(
          child: SafeArea(
            // Move body down since we extended behind app bar
            child: Column(
              children: [
                // Synergy Card
                Padding(
                        ...
                        return Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "Designing your custom path for '${job['title']}'",
                                style: GoogleFonts.nunito(
                                  fontSize: 12,
